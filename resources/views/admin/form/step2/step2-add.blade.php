...
<div class="flex h-screen bg-gray-100">
    <div class="m-auto">
        <div class="mt-5 bg-white rounded-lg shadow px-5">
            ...
            <form action="{{ url('form/step2/save') }}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <div class="container mx-auto px-4 max-w-full md:max-w-xl">
                <div class="mt-5 bg-white rounded-lg shadow px-5">
                    ...
                    <div id="percentageDisplay" class="py-3 bg-gray-100 px-2 py-2 rounded-lg pb-2" >
                        Persentase Step 2: <span class="lg text-red-500" id="percentageValue">0%</span>
                    </div>
                    ...
                    <div class="flex justify-between mt-6 px-2 gap-3">
                        <a href="{{ url('/form/identitas/add') }}">
